...
export const VIOLATIONS = {
  ...
  traffic_control_device: { points: 1, kind: 'moving',   label: 'Failure to obey a traffic control device' },
  lane_usage:             { points: 1, kind: 'moving',   label: 'Restricted lane usage / failure to maintain lane' },
  failure_to_yield:       { points: 1, kind: 'moving',   label: 'Failure to yield' },
  misc_traffic:           { points: 1, kind: 'moving',   label: 'Other miscellaneous traffic conviction' },
  oos_inspection:         { points: 1, kind: 'moving',   label: 'Out of Service roadside inspection' },
  // 2 points
  ...
  handheld_texting:       { points: 3, kind: 'moving',   label: 'Handheld mobile phone or texting', serious: true, handheld: true },
  railroad:               { points: 3, kind: 'moving',   label: 'Violation involving a railroad' },
  radar_detector:         { points: 3, kind: 'moving',   label: 'Using or equipping a CMV with a radar detector' },
  erratic_lane_change:    { points: 3, kind: 'moving',   label: 'Improper / erratic lane changing', serious: true },
  ...
  school_or_work_zone:    { prohibit_years: 3, label: 'Passing a school bus / speeding through a school, work or construction zone', serious: true },
  oos_order_violation:    { prohibit_years: 3, label: 'Violation of a driver or vehicle out-of-service order', serious: true },
  fleeing_police:         { prohibit_years: 3, label: 'Fleeing or eluding a police officer', serious: true },
  // 5-year prohibition
  dui_dwi:                { prohibit_years: 5, label: 'DUI / DWI', serious: true },
  drug_alcohol_offense:   { prohibit_years: 5, label: 'Drug or alcohol use / possession / intent', serious: true },
  fatality_accident:      { prohibit_years: 5, label: 'Preventable DOT recordable accident resulting in a fatality', serious: true, crash: true },
  hit_and_run:            { prohibit_years: 5, label: 'Leaving the scene of an accident / hit & run', serious: true },
  cmv_felony:             { prohibit_years: 5, label: 'Using a CMV in the commission of a felony', serious: true },
  negligent_homicide:     { prohibit_years: 5, label: 'Negligent homicide, manslaughter or assault involving a vehicle', serious: true },
