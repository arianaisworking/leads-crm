...
export const VIOLATIONS = {
  // 1 point
  speeding_1_10:          { points: 1, kind: 'moving',   label: 'Speeding 1–10 mph' , es: 'Exceso de velocidad 1–10 mph'},
  seatbelt:               { points: 1, kind: 'moving',   label: 'Seatbelt' , es: 'Cinturón de seguridad'},
  traffic_control_device: { points: 1, kind: 'moving',   label: 'Failure to obey a traffic control device' , short: 'Disobeyed a traffic signal or sign', es: 'Desobedecer una señal de tránsito'},
  lane_usage:             { points: 1, kind: 'moving',   label: 'Restricted lane usage / failure to maintain lane' , short: 'Failure to keep in lane', es: 'No mantenerse en el carril'},
  failure_to_yield:       { points: 1, kind: 'moving',   label: 'Failure to yield' , es: 'No ceder el paso'},
  misc_traffic:           { points: 1, kind: 'moving',   label: 'Other miscellaneous traffic conviction' , short: 'Another traffic ticket', es: 'Otra multa de tránsito'},
  oos_inspection:         { points: 1, kind: 'moving',   label: 'Out of Service roadside inspection' , short: 'Out-of-service roadside inspection', es: 'Inspección fuera de servicio'},
  // 2 points
  speeding_11_14:         { points: 2, kind: 'moving',   label: 'Speeding 11–14 mph' , es: 'Exceso de velocidad 11–14 mph'},
  improper_turn:          { points: 2, kind: 'moving',   label: 'Improper turn / U-turn' , es: 'Vuelta indebida o en U'},
  improper_passing:       { points: 2, kind: 'moving',   label: 'Improper passing' , es: 'Rebase indebido'},
  failure_to_signal:      { points: 2, kind: 'moving',   label: 'Failing to signal' , es: 'No usar direccionales'},
  preventable_crash:      { points: 2, kind: 'accident', label: 'Preventable crash', crash: true , es: 'Choque evitable'},
  // 3 points
  speeding_15_19:         { points: 3, kind: 'moving',   label: 'Speeding 15–19 mph', serious: true , es: 'Exceso de velocidad 15–19 mph'},
  following_too_closely:  { points: 3, kind: 'moving',   label: 'Following too closely', serious: true , es: 'Manejar muy pegado'},
  handheld_texting:       { points: 3, kind: 'moving',   label: 'Handheld mobile phone or texting', serious: true, handheld: true , short: 'Phone or texting while driving', es: 'Celular o mensajes al manejar'},
  railroad:               { points: 3, kind: 'moving',   label: 'Violation involving a railroad' , short: 'Railroad crossing violation', es: 'Infracción en cruce de tren'},
  radar_detector:         { points: 3, kind: 'moving',   label: 'Using or equipping a CMV with a radar detector' , short: 'Radar detector in the truck', es: 'Detector de radar en la troca'},
  erratic_lane_change:    { points: 3, kind: 'moving',   label: 'Improper / erratic lane changing', serious: true , short: 'Unsafe lane change', es: 'Cambio de carril inseguro'},
  // 3-year prohibition — not scored, an outright bar while inside the window
  speeding_20_plus:       { prohibit_years: 3, label: 'Speeding 20+ mph', serious: true , es: 'Exceso de velocidad 20+ mph'},
  school_or_work_zone:    { prohibit_years: 3, label: 'Passing a school bus / speeding through a school, work or construction zone', serious: true , short: 'School bus, school or work zone', es: 'Zona escolar o de obras'},
  oos_order_violation:    { prohibit_years: 3, label: 'Violation of a driver or vehicle out-of-service order', serious: true , short: 'Broke an out-of-service order', es: 'Violar una orden fuera de servicio'},
  fleeing_police:         { prohibit_years: 3, label: 'Fleeing or eluding a police officer', serious: true , short: 'Fleeing or eluding police', es: 'Huir de la policía'},
  // 5-year prohibition
  dui_dwi:                { prohibit_years: 5, label: 'DUI / DWI', serious: true , es: 'DUI / DWI'},
  drug_alcohol_offense:   { prohibit_years: 5, label: 'Drug or alcohol use / possession / intent', serious: true , short: 'Drug or alcohol offense', es: 'Delito de drogas o alcohol'},
  fatality_accident:      { prohibit_years: 5, label: 'Preventable DOT recordable accident resulting in a fatality', serious: true, crash: true , short: 'Accident involving a fatality', es: 'Accidente con una muerte'},
  hit_and_run:            { prohibit_years: 5, label: 'Leaving the scene of an accident / hit & run', serious: true , short: 'Left the scene / hit & run', es: 'Darse a la fuga'},
  cmv_felony:             { prohibit_years: 5, label: 'Using a CMV in the commission of a felony', serious: true , short: 'Used a truck in a felony', es: 'Usar la troca en un delito grave'},
  negligent_homicide:     { prohibit_years: 5, label: 'Negligent homicide, manslaughter or assault involving a vehicle', serious: true , short: 'Vehicular homicide or assault', es: 'Homicidio o agresión vehicular'},
  reckless_careless:      { prohibit_years: 5, label: 'Reckless / careless driving', serious: true , es: 'Manejo imprudente'},
};
